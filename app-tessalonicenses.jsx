...
// ============ STORAGE ============
const STORAGE_KEY = 'lectio-tessalonicenses-v1';
  ...
  return (
    <div className="fade-in">
      <div className="journey-header">
        <h1 className="journey-title">Treze dias com os Tessalonicenses</h1>
        <p className="journey-sub">As cartas mais antigas de Paulo — fé sob pressão, esperança diante da morte, trabalho e vida serena. Tradução NVI.</p>
