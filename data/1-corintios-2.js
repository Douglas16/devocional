...
window.CORINTIOS_2 = [
  {
    "theme": "Dons e amor · Um corpo, muitos membros",
    "date": "1 Coríntios 12",
    "verse": {
    ...
    "word": {
      ...
      "note": "Charisma é capacidade dada pela graça, não medalha de superioridade. O mesmo Espírito distribui diferentes dons para o bem comum, de modo que nenhum membro pode dispensar o outro."
    },
    "context": "Depois de corrigir a desigualdade à mesa, Paulo trata dos dons espirituais. Corinto valorizava manifestações visíveis, mas Paulo desloca a pergunta: todo dom vem do Espírito e deve servir à unidade e à edificação do corpo.",
    "passage": {
    ...
    "meditation": [
      "Dons não são propriedade privada; são expressões da generosidade do Espírito para o bem comum.",
      "O corpo precisa da diferença. A uniformidade pode parecer eficiente, mas a unidade cristã acolhe membros com funções e necessidades distintas.",
      "Sofrer e alegrar-se juntos é a evidência de que deixamos de tratar a comunidade como plateia ou serviço de consumo."
    ],
    "questions": [
      "Que dom você pode oferecer com simplicidade ao corpo?",
      "Que membro você tem tratado como dispensável?",
      "Como você pode se aproximar de alguém que sofre hoje?"
    ],
    "application": "Use uma habilidade sua para servir a alguém da comunidade nesta semana e pergunte a uma pessoa como ela realmente está.",
    "prayer": "Espírito Santo, obrigado pelos dons que distribuis. Livra-me da comparação e faz-me servir para o bem do corpo de Cristo. Amém."
  },
  {
    "theme": "Dons e amor · O caminho mais excelente",
    "date": "1 Coríntios 13",
    "verse": {
    ...
    "word": {
      ...
      "note": "Agapē não é emoção passageira nem abstração romântica. No centro da discussão sobre dons, é o modo concreto de agir com paciência, verdade, perseverança e recusa da autopromoção."
    },
    "context": "O capítulo está entre as orientações sobre dons dos capítulos 12 e 14. Paulo não interrompe o assunto para escrever um poema isolado: mostra que qualquer capacidade espiritual perde seu sentido quando não é exercida em amor.",
    "passage": {
    ...
    "meditation": [
      "Paulo coloca o amor acima de habilidades impressionantes. Sem ele, até o que parece espiritual pode virar ruído e autopromoção.",
      "Amor paciente e bondoso não é fraco: ele recusa a injustiça e celebra a verdade. Graça e verdade permanecem unidas.",
      "Fé, esperança e amor permanecem, mas o amor é maior porque é o caráter de Deus já praticado no presente e levado à sua plenitude."
    ],
    "questions": [
      "Que habilidade sua precisa ser submetida ao amor?",
      "Onde você tem guardado rancor em vez de buscar o bem?",
      "Como unir bondade e verdade numa relação difícil?"
    ],
    "application": "Escolha uma descrição do amor em 1 Coríntios 13 e pratique-a de modo observável em uma relação específica hoje.",
    "prayer": "Deus de amor, transforma minhas palavras e dons. Dá-me paciência, verdade e coragem para buscar o bem do outro. Amém."
  },
  {
    "theme": "Dons e amor · Tudo para edificação",
    "date": "1 Coríntios 14",
    "verse": {
    ...
    "word": {
      ...
      "lang": "grego",
      "meaning": "edificação",
      "note": "Edificar é construir uma casa habitável. Paulo mede a reunião cristã não pela intensidade individual da experiência, mas por aquilo que fortalece, consola e instrui a comunidade inteira."
    },
    "context": "Paulo continua a orientar os dons reunidos no culto. Ele valoriza a participação, mas pede inteligibilidade, discernimento e ordem, para que todos possam ser fortalecidos e Deus seja honrado.",
    "passage": {
    ...
    "meditation": [
      "Buscar dons e seguir o amor são duas partes de uma única vocação. Não precisamos escolher entre dependência do Espírito e cuidado com as pessoas.",
      "Palavras compreensíveis são um ato de hospitalidade. Elas não exibem uma experiência privada; tornam a verdade acessível ao outro.",
      "Ordem não é controle rígido; é paz que cria espaço para participação, discernimento e crescimento de todos."
    ],
    "questions": [
      "Suas palavras tornam o caminho de Deus mais compreensível ou mais confuso?",
      "Como você pode encorajar alguém de forma concreta?",
      "Que prática comunitária precisa ser avaliada pelo critério da edificação?"
    ],
    "application": "Envie uma mensagem de encorajamento específica a alguém e use palavras simples, verdadeiras e compreensíveis.",
    "prayer": "Espírito de Deus, dá-me palavras que edificam. Forma em nossa comunidade uma paz que acolhe, discerne e fortalece. Amém."
  },
  {
    "theme": "A esperança da ressurreição · Cristo ressuscitou",
    ...
    "word": {
      ...
      "note": "Anástasis significa levantar-se novamente. Paulo não fala apenas de uma influência duradoura de Jesus: afirma que Deus ressuscitou Cristo e, por isso, a morte não terá a última palavra sobre os que lhe pertencem."
    },
    "context": "Alguns em Corinto negavam a ressurreição dos mortos. Paulo responde recordando o evangelho recebido, as testemunhas do Ressuscitado e as consequências devastadoras de uma fé sem ressurreição.",
    "passage": {
      "ref": "1 Coríntios 15.1-34",
      "verses": [
        {
          "n": 1,
    ...
    "meditation": [
      "A ressurreição não é enfeite no fim do evangelho. Ela confirma a vitória de Cristo e torna a esperança cristã uma resposta real à morte.",
      "Paulo é honesto: sem ressurreição, a fé perde seu centro. Nossa confiança não repousa numa ideia inspiradora, mas no Cristo vivo.",
      "Como primícias, Jesus é o começo de uma colheita. Sua ressurreição promete o futuro de todos os que lhe pertencem."
    ],
    "questions": [
      "Que diferença a ressurreição faz diante de um medo concreto?",
      "Você tem reduzido Jesus a mestre moral, deixando de lado sua vitória real?",
      "Como a esperança futura pode moldar suas decisões presentes?"
    ],
    "application": "Diante de uma notícia ou perda dolorosa, faça uma oração curta que una lamento e esperança: 'Cristo ressuscitou; a morte não terá a última palavra'.",
    "prayer": "Jesus vivo, firma minha fé na tua ressurreição. Sustenta-me diante da morte e faz minha esperança ser concreta e perseverante. Amém."
  },
  {
    "theme": "A esperança da ressurreição · Firmes no Senhor",
    ...
    "word": {
      ...
      "note": "Paulo contrasta o que se desgasta com aquilo que Deus transformará. A esperança não descarta o corpo como prisão; ela aguarda que Deus vista o mortal de vida imperecível."
    },
    "context": "Paulo responde à pergunta sobre como os mortos ressuscitam usando imagens de semente e colheita. Deus dá um corpo transformado e derrota a morte; por isso, o trabalho no Senhor não é inútil.",
    "passage": {
      "ref": "1 Coríntios 15.35-58",
      "verses": [
        {
          "n": 35,
    ...
    "meditation": [
      "Deus não abandona o que criou. A ressurreição afirma que nossa história corporal importa e será alcançada pela transformação de Deus.",
      "A vitória sobre a morte não elimina lágrimas presentes, mas impede que o desespero seja a palavra final.",
      "Porque o Senhor ressuscitou, o serviço aparentemente pequeno não é em vão. A esperança futura dá peso e permanência à fidelidade de hoje."
    ],
    "questions": [
      "Que fragilidade você precisa enxergar à luz da promessa de transformação?",
      "Onde o medo da morte tem limitado sua esperança?",
      "Que obra do Senhor você pode continuar sem medir tudo por resultado imediato?"
    ],
    "application": "Retome ou apoie uma pequena obra de cuidado e serviço que parecia sem resultado, entregando seus frutos a Deus.",
    "prayer": "Deus da vida, obrigado porque a morte não vence. Mantém-me firme e faz meu trabalho no Senhor ser expressão de esperança. Amém."
  },
  {
    "theme": "Uma comunidade enviada · Generosidade e parceria",
    ...
    "word": {
      ...
      "note": "A coleta para os cristãos necessitados de Jerusalém é diaconia: uma expressão organizada de comunhão material entre igrejas separadas por distância, cultura e história."
    },
    "context": "A carta termina com assuntos muito concretos: uma coleta para Jerusalém, planos de viagem e cooperadores. Paulo une generosidade regular, transparência, planejamento e atenção ao que Deus está abrindo.",
    "passage": {
      "ref": "1 Coríntios 16.1-12",
      "verses": [
        {
          "n": 1,
    ...
    "meditation": [
      "Generosidade em Corinto é planejada, proporcional e comunitária. Não depende apenas de impulso emocional; torna-se hábito de amor.",
      "Paulo cuida da transparência da coleta. Recursos para servir pessoas precisam de integridade que preserve a confiança.",
      "Portas abertas e adversários podem existir juntos. Uma oportunidade dada por Deus não significa necessariamente um caminho sem resistência."
    ],
    "questions": [
      "Sua generosidade tem espaço planejado em sua vida?",
      "Como você pode exercer transparência ao servir com recursos?",
      "Que porta de serviço está aberta, mesmo trazendo dificuldades?"
    ],
    "application": "Separe uma quantia ou um recurso específico para ajudar alguém ou uma missão, de forma planejada e responsável.",
    "prayer": "Senhor, tudo o que tenho vem de ti. Forma em mim generosidade fiel, integridade no serviço e coragem para atravessar portas abertas. Amém."
  },
  {
    "theme": "Uma comunidade enviada · Coragem que se expressa em amor",
    ...
    "word": {
      ...
      "note": "O imperativo final não opõe coragem e amor. Para Paulo, firmeza cristã não é dureza: toda vigilância, força e serviço precisam receber sua forma do amor."
    },
    "context": "Paulo encerra a carta com uma série de recomendações, saudações e nomes. A igreja é chamada a apoiar pessoas que servem, a permanecer firme e a deixar que o amor molde tudo aquilo que faz.",
    "passage": {
      "ref": "1 Coríntios 16.13-24",
      "verses": [
        {
          "n": 13,
    ...
    "meditation": [
      "Vigilância e firmeza não pedem uma personalidade agressiva. São práticas de quem permanece atento ao evangelho e às pressões que o desviam.",
      "Paulo valoriza uma casa dedicada ao serviço. Comunidades saudáveis aprendem a reconhecer e apoiar trabalho fiel, especialmente o menos visível.",
      "'Façam tudo com amor' é o resumo que percorre a carta: cruz, corpo, liberdade, dons e ressurreição ganham forma concreta quando o amor dirige a ação."
    ],
    "questions": [
      "Em que área você precisa de firmeza sem perder ternura?",
      "Quem serve de modo discreto e merece apoio ou reconhecimento?",
      "O que mudaria se você submetesse uma decisão atual ao critério do amor?"
    ],
    "application": "Agradeça de maneira específica uma pessoa que serve nos bastidores e escolha uma ação do dia para fazer intencionalmente com amor.",
    "prayer": "Senhor Jesus, mantém-me vigilante e firme. Dá-me coragem sem dureza e faz tudo em minha vida ser governado pelo teu amor. Amém."
  }
];
